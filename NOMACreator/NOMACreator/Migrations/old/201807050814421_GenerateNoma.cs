    ...
    public partial class GenerateNoma : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.lehrer", t => t.Lehrer_Id1)
                .ForeignKey("dbo.lehrer", t => t.Klassenleiter_Id)
                .ForeignKey("dbo.schule", t => t.Schule_Id)
                .ForeignKey("dbo.lehrer", t => t.StellvertretenderKlassenleiter_Id)
                .Index(t => t.Lehrer_Id)
        ...
        {
            DropForeignKey("dbo.klasse", "StellvertretenderKlassenleiter_Id", "dbo.lehrer");
            DropForeignKey("dbo.klasse", "Schule_Id", "dbo.schule");
            DropForeignKey("dbo.klasse", "Klassenleiter_Id", "dbo.lehrer");
            ...
            DropForeignKey("dbo.klasse", "Lehrer_Id1", "dbo.lehrer");
            DropForeignKey("dbo.klasse", "Lehrer_Id", "dbo.lehrer");
            ...
            DropIndex("dbo.klasse", new[] { "StellvertretenderKlassenleiter_Id" });
            DropIndex("dbo.klasse", new[] { "Schule_Id" });
            DropIndex("dbo.klasse", new[] { "Klassenleiter_Id" });
            DropIndex("dbo.klasse", new[] { "Lehrer_Id1" });
            DropIndex("dbo.klasse", new[] { "Lehrer_Id" });
